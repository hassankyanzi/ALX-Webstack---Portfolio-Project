...
<head>
	...
	<title>Kutafuta Kazi- Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Kitintale, <br/> PO.BOX 2589, KAMPALA <br/>Uganda</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:kyanzi.hassan2@gmail.com">kyanzi.hassan2@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+256 701 761425">+256 701 761425</a>
								</li>
								...
								<li>
										...
										<div class="contact-social">
											...
											<a href="<?php echo "$tw"; ?>" data-toggle="tooltip" data-placement="top" title="X"><i class="fa fa-X"></i></a>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Kutafuta Kazi is a swahili word for look for a job. This system is an online job board. Developed and managed by Kyanzi Hassan Musisi</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> One dice software development inc.</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Kyanzi Hassan Musisi</a></li>
								</ul>
							...
							<div class="col-sm-4 col-md-4">
								<ul class="bottom-footer-menu for-social">
									<li><a href="<?php echo "$tw"; ?>"><i class="ri ri-X" data-toggle="tooltip" data-placement="top" title="X"></i></a></li>
